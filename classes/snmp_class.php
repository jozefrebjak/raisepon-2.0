...
class snmp_oid {	
	...
	private $olt_oid = array (
		"olt_status_oid" => "1.3.6.1.2.1.1.3.0",
                ...
                "olt_serial_number_oid" => '1.3.6.1.4.1.2011.6.3.3.1.1.9.0',
                "olt_hw_version_oid" => '1.3.6.1.4.1.2011.6.3.1.999.0',
                "olt_model_oid" => '1.3.6.1.2.1.47.1.1.1.1.2.888624',
                ...
                "ifHCInOctets" => ".1.3.6.1.2.1.2.2.1.10",
                "ifHCOutOctets" => ".1.3.6.1.2.1.2.2.1.16",
                "ifHCInUcastPkts" => ".1.3.6.1.2.1.2.2.1.11",
                "ifHCOutUcastPkts" => ".1.3.6.1.2.1.2.2.1.17",
                "ifHCInMulticastPkts" => ".1.3.6.1.2.1.31.1.1.1.2",
                "ifHCOutMulticastPkts" => ".1.3.6.1.2.1.31.1.1.1.4",
                "ifHCInBroadcastPkts" => ".1.3.6.1.2.1.31.1.1.1.3",
                "ifHCOutBroadcastPkts" => ".1.3.6.1.2.1.31.1.1.1.5",
